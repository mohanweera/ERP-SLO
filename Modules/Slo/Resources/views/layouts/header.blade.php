                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/addNewBatchType">Add New Batch Type</a>
                                <a class="dropdown-item" href="/batchTypeList">Batch Type List</a>
                                <!-- <a class="dropdown-item" href="/slo/batchType/edit">Edit Batch Type</a> -->
                                <a class="dropdown-item" href="/addNewBatch">Add New Batch</a>
                                <a class="dropdown-item" href="/batchList">Batch List</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/addNewIdRange">Add New Range</a>
                                <a class="dropdown-item" href="/idRangeList">ID Range List</a>
                                <!-- <a class="dropdown-item" href="/academic/faculty/trash">Update Student Full Details</a> -->
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="">Student Upload Home</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="">Upload Category</a>
